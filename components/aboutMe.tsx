...
<div className="flex lg:flex-row xs:flex-col lg:justify-center items-center lg:h-4/5 xs:h-[1800px] w-screen">
	...
	<div className="flex items-center justify-center xs:w-full lg:w-1/2 xl:w-2/6 h-full text-left">
		<div className="mx-5 min-h-screen grid place-content-center ">
			...
			<div className="bg-white py-8 rounded-md shadow-2xl transform -translate-y-20 sm:-translate-y-24 w-10/12 mx-auto text-black">
